...
export default function Status({ status = 1 }) {
    return (
        <SafeAreaView style={{ backgroundColor: '#fff', flex: 1 }}>
            <HeaderWithBackButton title={'Trạng thái'} />
            <View >
                ...
                <Button title={'Quay lại'} filled style={{ borderRadius: 6, marginHorizontal: 18, marginTop: 50, backgroundColor: status == 1 ? '#22b07e' : '#f44236', borderWidth: 0 }} />
            </View>
        </SafeAreaView >
    );
}