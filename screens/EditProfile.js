...
const EditProfile = ({ route, navigation }) => {
    ...
    const userFields = [
        ...
        { field: "gender", label: "Giới tính", type: "select", options: ["Nam", "Nữ"] },
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (error.response && error.response.status === 400)
                ...
                setError("The field file exceeds its maximum permitted size of 1048576 bytes.");
        }
        ...
        <View style={{ backgroundColor: "white", flex: 1 }}>
            ...
            {user && (
                <ScrollView style={styles.formContainer}>
                        ...
                        return (
                            <View key={field} style={styles.fieldContainer}>
                                ...
                                {type === "text" ? (
                                    ...
                                    <RadioButton.Group onValueChange={value => handleInputChange(field, value)} value={user[field]}>

                                        <View style={{ flexDirection: 'row' }}>
                                            <RadioButton.Item label="Nam" value={0} status={user[field] === 0 ? 'checked' : 'unchecked'} />
                                            <RadioButton.Item label="Nữ" value={1} status={user[field] === 1 ? 'checked' : 'unchecked'} />
                                        </View>
                    ...
                    {error && (
                        <View style={{ backgroundColor: "#DC4C64", padding: 10, marginBottom: 10, borderRadius: 10 }}>
